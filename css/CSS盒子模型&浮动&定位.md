...
![定位示例1](imgs/定位示例1.gif)

* **当我们滚动窗口的时候，盒子是固定屏幕某个位置的**

![定位示例2](imgs/定位示例2.png)
...
### 3.10.4 相对定位(relative)

* **相对定位**是元素**相对**于它  原来在标准流中的位置 来说的。（自恋型）

![相对定位案例](imgs/相对定位案例.png)
...
2. **父元素没有定位**，则以**浏览器**为准定位（Document 文档）。
   ...
   ![绝对定位_父级无定位](imgs/绝对定位_父级无定位.png)

3. **父元素要有定位**

   * 将元素依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

![绝对定位_父级有定位](imgs/绝对定位_父级有定位.png)
