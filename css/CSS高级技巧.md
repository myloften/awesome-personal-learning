...
所以我们知道，我们可以通过vertical-align 控制图片和文字的垂直关系了。 默认的图片会和文字基
...
- 解决的方法就是：  
  ...
  - 给img vertical-align:middle | top| bottom等等。  让图片不要和基线对齐。![vertical1](imgs/vertical1.png)
  - 给img 添加 display：block; 转换为块级元素就不会存在问题了。![vertical2](imgs/vertical2.png)
...
之所以需要精灵技术：**为了有效地减少服务器接受和发送请求的次数，提高页面的加载速度。**
...
制作网页时，为了美观，常常需要为网页元素设置特殊形状的背景，比如微信导航栏，有凸起和凹下去的感觉，最大的问题是里面的字数不一样多，咋办？http://weixin.qq.com/
